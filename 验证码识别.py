...
BATCH_SIZE = 25
# tfrecord文件存放路径
TFRECORD_FILE = "D:\\pycharm\\fireman\\new 3.5\\slcjtensorflow\\to tfrecord\\aptcha"
...
print(image_batch)#[25,224,224]
# tf.reshape(image_batch, [BATCH_SIZE, 224, 224, 1])
print('1111')
#定义网络结构
...
with tf.Session() as sess:
    ...
    for i in range(6001):
        ...
        if i % 20 == 0:  
            ...
            if i==6000:
                saver.save(sess, "D:\\pycharm\\fireman\\new 3.5\\slcjtensorflow\\to tfrecord\\aptcha\\models", global_step=i)
                break 
